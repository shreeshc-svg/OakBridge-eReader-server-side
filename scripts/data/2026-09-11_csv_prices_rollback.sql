-- =============================================================================
-- UNDO of 2026-09-11_csv_prices.sql: make these books free again
-- Date:    2026-09-11
-- Source:  oakbridge_ebook_upload_51_priced.csv (column: ebook_price, in ₹)
-- =============================================================================
--
-- Sets price back to 0 ONLY for books whose price still equals the value the
-- apply script set. If someone changed a price by hand afterwards, that book is
-- left alone.
-- =============================================================================
...
WHERE trim(b.isbn) = c.isbn
  AND b.price = c.new_price;

SELECT count(*) AS free_books_now FROM books WHERE price = 0;
